<div class="container">
    ...
    <?php
        ...
        JOIN tbl_sanpham c ON a.id_sanpham=c.id_sanpham
        WHERE b.id_taikhoan='$user' and c.tensp like '%$key%'";
    ...
    <?php
        $sql="SELECT * FROM  tbl_donhang b JOIN tbl_chitietdonhang a ON a.id_donhang=b.id_donhang 
        JOIN tbl_sanpham c ON a.id_sanpham=c.id_sanpham
        WHERE b.id_donhang='$row1[id_donhang]' and c.tensp like '%$key%' ";
    ...
    <tr>
      ...
      <?php  
    }}else {echo '<p class="text-center mt-4">"Chưa có đơn hàng"</p>';}
    ?>
</div>
