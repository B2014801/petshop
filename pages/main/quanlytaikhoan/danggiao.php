<div class="container">
    ...
    <?php
        ...
        $sql="SELECT * FROM  tbl_donhang b WHERE b.id_taikhoan='$user' and (b.trangthai_donhang=1 or b.trangthai_donhang=2)";
    ...
    ?>
     <table class="table table-bordered table-responsive-sm shadow w-75 mx-auto">
        <tbody>
            <tr>
                <td colspan="2"><p class="mb-0 text-success"><i class="fa-solid fa-truck"></i> Đơn hàng đang trên đường giao đến bạn</p> </td>
            </tr>
    <?php
        $sql="SELECT * FROM  tbl_donhang b JOIN tbl_chitietdonhang a ON a.id_donhang=b.id_donhang 
        JOIN tbl_sanpham c ON a.id_sanpham=c.id_sanpham WHERE b.id_donhang='$row1[id_donhang]' and (b.trangthai_donhang=1 or b.trangthai_donhang=2)";
